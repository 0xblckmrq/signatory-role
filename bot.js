...
btn.addEventListener("click", async () => {
  ...
  try {
    ...
    msgInput.value = challenge; // Display challenge after wallet connected
    ...
    status.innerText = "✅ Signature created! Submitting to bot...";
    ...
    if (result.success) {
      status.innerText = "🎉 Verification complete! Role assigned. Private channel will be deleted shortly.";
    } else {
