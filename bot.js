...
Click the link below to connect your wallet and sign the challenge automatically:

🔗 ${signerUrl}

Verification is automatic — role will be assigned after signing. Private channel will delete after verification.
      `);
